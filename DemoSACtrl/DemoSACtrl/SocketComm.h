...
public:
	...
	bool ConnectTo(LPCTSTR strDestination, LPCTSTR strServiceName, int nProtocol, int nType, 
					bool no_blocking = false , long tv_sec = 0, long tv_usec = 0, LPCTSTR strBindAddr = NULL);
...
// Data function
	...
	// Utility functions
	static SOCKET WaitForConnection(SOCKET sock, sockaddr_in& clientaddr ); // Wait For a new connection (Server side)
	...
	static void GetAllIPAddress( LPCTSTR strHostName, ULONG* paddrList, UINT nListLen );
