...
BEGIN_MESSAGE_MAP(CDemoSACtrlApp, CWinApp)
...
// 唯一的一个 CDemoSACtrlApp 对象

CDemoSACtrlApp theApp;


// CDemoSACtrlApp 初始化

BOOL CDemoSACtrlApp::InitInstance()
{
